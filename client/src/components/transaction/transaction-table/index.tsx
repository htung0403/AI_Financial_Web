...
const TransactionTable = (props: {
  ...
  const pagination = {
    totalItems: data?.transactions?.pagination?.totalCount || 0,
    totalPages: data?.transactions?.pagination?.totalPages || 0,
    pageNumber: filter.pageNumber,
    pageSize: filter.pageSize,
  };
  ...
  return (
    <DataTable
      data={transactions} // Use real data instead of TRANSACTION_DATA
