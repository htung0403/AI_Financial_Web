...
import { useCreateTransactionMutation, useUpdateTransactionMutation, useGetSingleTransactionQuery } from "@/features/transaction/transactionAPI";
...
const TransactionForm = (props: { 
  ...
  const { data } = useGetSingleTransactionQuery(
